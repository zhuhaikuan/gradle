...
class DefaultPublishArtifactSetTest extends Specification {
    final collectionFactory = TestUtil.domainObjectCollectionFactory()
    final store = collectionFactory.newDomainObjectSet(PublishArtifact)
    final set = collectionFactory.newContainer(DefaultPublishArtifactSet, PublishArtifact, 'artifacts', store, fileCollectionFactory())
