...
class VariantsMetaDataHelperTest extends Specification {
    ...
    def "computes the set of incompatible variant dimensions for #referenceClass.simpleName(#dimensions) onto #candidateClass.simpleName are #expectedIncompatible"() {
        given:
