        ...
        HttpRedirectVerifier redirectVerifier =
            HttpRedirectVerifierFactory.create(
                ...
                () -> DeprecationLogger
                    ...
                    .withAdvice("Switch the URI to '%s' or try 'resources.text.fromInsecureUri(\"%s\")' to silence the warning.", GUtil.toSecureUrl(rootUri), rootUri)
                    .withContext("The provided URI '%s' uses an insecure protocol (HTTP).", rootUri)
                ...
                redirect -> DeprecationLogger
                    ...
                    .withContext("'%s' redirects to insecure '%s'.", uri, redirect)
                    .willBeRemovedInGradle7()
                    .withDslReference(TextResourceFactory.class, "fromInsecureUri(java.lang.Object)")
                    .nagUser()
            );
