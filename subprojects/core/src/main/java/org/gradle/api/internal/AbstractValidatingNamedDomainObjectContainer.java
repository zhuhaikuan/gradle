...
public abstract class AbstractValidatingNamedDomainObjectContainer<T> extends AbstractNamedDomainObjectContainer<T> {
    ...
    protected AbstractValidatingNamedDomainObjectContainer(Class<T> type, Namer<? super T> namer) {
        super(type, namer);
        nameDescription = type.getSimpleName() + " name";
    }

    protected AbstractValidatingNamedDomainObjectContainer(Class<T> type) {
        super(type);
        nameDescription = type.getSimpleName() + " name";
    }
